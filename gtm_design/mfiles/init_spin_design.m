function MWS = init_spin_design(vehicle,noise_on,fuelburn_on)
%
% Initializes the Model Workspace Structure for simulating a targeted oscillatory 
% spin condition.
%
% Inputs:
...
%
%
% This function initializes the simulation environment for an oscillatory spin condition 
...
% targeted oscillatory spin condition.
%
%% About
%
% Author:     Omar Mourad
...
% Oscillatory Spin Initial Conditions
ini.Altitude =     0;          % ft

ini.tas      =     30.42;      % (meter/sec)

ini.alpha    =     34.032;           % deg
ini.beta     =     9.934;           % deg
